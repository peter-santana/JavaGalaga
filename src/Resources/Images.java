...
public class Images {
    ...
    public static BufferedImage galagaBeeLaser;
    ...
    public static BufferedImage  galagaBadBunny;
    ...
    public Images() {
        ...
        try {
            ...
            galagaBadBunny = ImageIO.read(getClass().getResourceAsStream("/UI/Misc/badbunny.png"));
            ...
            galagaNewEnemy[0] = galagaSpriteSheet.crop(200, 103, 17, 16);
            galagaNewEnemy[1] = galagaSpriteSheet.crop(159, 102, 18, 18);
            galagaNewEnemy[2] = galagaSpriteSheet.crop(136, 103, 15, 14);
            galagaNewEnemy[3] = galagaSpriteSheet.crop(113, 102, 15, 14);
            galagaNewEnemy[4] = galagaSpriteSheet.crop(89, 102, 15, 14);
            galagaNewEnemy[5] = galagaSpriteSheet.crop(65, 102, 15, 14);
            galagaNewEnemy[6] = galagaSpriteSheet.crop(42, 103, 15, 14);
            galagaNewEnemy[7] = galagaSpriteSheet.crop(19, 102, 15, 14);


            galagaPlayerLaser = galagaSpriteSheet.crop(365 ,219,3,8);
            galagaBeeLaser = galagaSpriteSheet.crop(367, 72, 13, 11);
